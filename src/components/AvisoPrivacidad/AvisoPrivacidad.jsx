...
export const AvisoPrivacidad = () => {
  return (
    <div className="mb-5">
      <h2 className="d-flex justify-content-center my-5 avisoTitulo">
        Aviso de privacidad
      </h2>
      <div className="mx-5 avisoTexto">
        Laminas en Puebla .Com S DE RL DE CV, con domicilio en Puebla, C.P.
        72530, en la entidad de Puebla, País México, y portal de internet
        www.laminasenpuebla.com, es el responsable del uso y protección de sus
        ...
        <ul className="my-4">
          <li>Promover los productos y servicios que ofrecemos</li>
        ...
        www.laminasenpuebla.com
        <br />
        <Button href="/" className="avisoButton danger mb-5">
